...
*An example of an unannotated premature termination codon-containing transcript identified by running `cds_insertion.py` on a stringtie-augmented transcriptome GTF*
