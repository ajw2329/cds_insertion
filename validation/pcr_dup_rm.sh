...
export bam_dir=/public/groups/sanfordlab/people/anjowall/projects/nmd_validation/bam/
...
export fastq_dir=/public/groups/sanfordlab/people/anjowall/projects/nmd_validation/fastq/
export fastq_prefix_list=$(ls "$fastq_dir"/*fastq.gz | awk -F\/ '{ print $NF}' | awk -F"_[12].fastq" '{ print $1 }' | sort | uniq)
###

bam_dir_rmdup=/public/groups/sanfordlab/people/anjowall/projects/nmd_validation/bam_rmdup/
